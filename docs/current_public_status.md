...
Product notes for the DigitalArtDeco Labs company website, updated 9 September 2026. The implementation scope below was reviewed on 6 September 2026; the new user-supplied screenshots document visible application states. The company website’s development direction describes future goals, not additions to this implemented scope.
...
Saved field components retain native Yee coordinates, component units, saved step and slice selection. The current field screenshot shows the Via Transition example: signed H_z in A/m at saved step 12288 on Z slice 16. This is a time-domain state, not a field at the S-parameter marker frequency. The earlier Hy and Ez captures remain historical records, not the current presentation.
...
1. Five user-supplied captures for the 9 September 2026 company presentation establish the visible construction and result views. The earlier 5 September captures remain historical records.
