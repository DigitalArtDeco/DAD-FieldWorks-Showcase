...
This public showcase animation shows an analytic rectangular PEC cavity
reference field, a sampled discrete candidate field, a finite difference
residual check and an explicit evidence gate.
...
The field is created from closed form equations. The discrete candidate
